...
export const NISSAI_CATALOG = [
  ...
  },
  {
    ...
    desc: 'Robás el 30% del IC del objetivo (mín 50, máx 500 IC). Inmediato.',
...
const CASINO_OUTCOMES = [
  ...
  { result: 'WIN',     mult: 2.5, label: '💰 WIN ×2.5',     prob: 0.23 },
  { result: 'SMALL',   mult: 1.5, label: '✨ SMALL ×1.5',   prob: 0.23 },
  { result: 'LOSE',    mult: 0.0, label: '💀 PERDISTE TODO', prob: 0.50 },
];
